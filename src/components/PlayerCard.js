  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      {player.currentRoundContribution > 0 && (
        <div className="absolute -top-10 md:-top-10 z-10 glass-panel px-2.5 md:px-2 py-1 bg-zinc-900/90 border-zinc-700 shadow-lg flex items-center gap-1.5 animate-pop">
          <MiniChipStack amount={player.currentRoundContribution} />
          <span className="font-mono text-xs md:text-[10px] text-zinc-300 font-bold ml-0.5">
      ...
      <div className={`w-24 md:w-28 min-h-[74px] md:min-h-0 glass-panel p-2.5 md:p-3 border-2 transition-all duration-300 ${ringClasses} ${isCurrentTurn ? 'scale-105 md:scale-100 shadow-[0_0_22px_rgba(251,191,36,0.22)] md:shadow-none' : ''} ${isMe ? 'ring-2 ring-emerald-500/40 ring-offset-1 ring-offset-[#091812]' : ''}`}>
