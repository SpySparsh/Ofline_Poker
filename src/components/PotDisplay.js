...
export default function PotDisplay({ potAmount }) {
  ...
  return (
    <div className={`flex flex-col items-center justify-center transition-transform ${isPulsing ? 'scale-110' : 'scale-100'}`}>
       <div className="text-zinc-500 text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] mb-1 md:mb-2">Total Pot</div>
       <div className="glass-panel px-5 md:px-8 py-2.5 md:py-4 flex items-center gap-2.5 md:gap-4 bg-black/60 shadow-[0_10px_30px_rgba(16,185,129,0.15)] border-emerald-900/30">
          ...
          <div className="text-3xl md:text-5xl font-mono font-bold text-white tracking-widest drop-shadow-[0_0_8px_rgba(16,185,129,0.4)]">
