...
export default function GamePage() {
  ...
  return (
    <div className="min-h-dvh flex flex-col relative overflow-hidden">
      ...
      {/* === TOP BAR === */}
      <div className="relative z-20 flex flex-wrap items-start justify-between px-3 pt-3 pb-1 gap-2">
        <div className="glass-panel px-3 py-1.5 bg-black/50 text-[10px] font-mono text-zinc-500 uppercase tracking-widest mt-1">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          ...
          <button
            onClick={toggleMute}
            className="glass-panel px-2 py-1.5 bg-black/50 hover:bg-zinc-800/50 text-zinc-400 hover:text-zinc-200 transition-colors text-[10px] uppercase tracking-wider h-full"
          ...
          <button 
            ...
            className="glass-panel px-3 py-1.5 bg-black/50 hover:bg-emerald-900/50 text-emerald-400 font-bold border border-emerald-500/30 transition-colors text-[10px] uppercase tracking-wider flex items-center gap-1.5 h-full"
          >
